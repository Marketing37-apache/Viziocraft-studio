...
const SERVICES: Service[] = [
  ...
  {
    t: "Publicités vidéo",
    short: "Ads pensées pour convertir",
    desc: "Un hook qui stoppe le scroll, un rythme qui retient, des formats adaptés à chaque plateforme.",
    bullets: ["Multi-formats", "Sous-titres animés", "Itération rapide"],
  ...
  {
    t: "Podcast vidéo",
    short: "Multi-cam et clips dérivés",
    desc: "Synchro multi-caméra, habillage cohérent, shorts extraits de chaque épisode.",
    bullets: ["Multi-cam sync", "Shorts extraits", "Chapitrage"],
  ...
  {
    t: "Shorts & Reels",
    short: "Du scroll stoppé, tous les jours",
    desc: "Montage natif 9:16, sous-titres animés, hook dès la première seconde.",
    bullets: ["9:16 natif", "Sous-titres animés", "Volume sans perte"],
  ...
  {
    t: "Motion design",
    short: "Animation à votre image",
    desc: "Logos animés, textes en mouvement, intros et transitions sur-mesure.",
    bullets: ["After Effects", "Textes animés", "Réutilisable"],
  ...
  {
    t: "Formats longs",
    short: "YouTube qui retient l'attention",
    desc: "Montage narratif, b-rolls, étalonnage et habillage — pour que vos viewers restent jusqu'au bout.",
    bullets: ["Structure narrative", "Étalonnage", "Habillage inclus"],
