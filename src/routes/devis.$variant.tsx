...
const META: Record<Variant, {
  ...
  surmesure: {
    eyebrow: "Configurateur · Production sur mesure",
    title: "Composez une production ",
    highlight: "100% à la carte.",
    baseline: "Mix shorts + longs, options avancées, livraison express. Le configurateur s'adapte à votre volume réel et calcule un devis personnalisé en direct.",
    bg: "bg-[#0b0716]",
    ink: "text-white",
    accent: "text-[#c4b5fd]",
